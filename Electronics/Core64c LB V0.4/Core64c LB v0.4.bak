...
U 5E75D6AB
F0 "Sense_LEDs_ID" 50
F1 "Core64C LB v0.4 Sense_LEDs_ID.sch" 50
$EndSheet
$Sheet
S 8750 850  1500 250 
U 5EA63449
F0 "Expansion" 50
F1 "Core64C LB v0.4 Expansion.sch" 50
$EndSheet
...
U 5E7548ED
F0 "Power" 50
F1 "Core64C LB v0.4 Power.sch" 50
$EndSheet
...
U 5E755AC8
F0 "Driver" 50
F1 "Core64C LB v0.4 Driver.sch" 50
$EndSheet
Wire Wire Line
	7850 4050 7850 3950
...
SPARE4_or_CP4
$Comp
L Pico_SC0915_Sequential:SC0915 U7
U 1 1 60BB3F56
P 3950 1950
F 0 "U7" H 4300 2200 60  0000 C CNN
...
Q7N
Text GLabel 5850 6350 2    50   Output ~ 0
Q10N
...
U 1 1 60B8F24D
P 700 6950
F 0 "C14" H 450 7000 50  0000 L CNN
...
F 5 "yes" H 700 6950 50  0001 C CNN "Populate"
	1    700  6950
	-1   0    0    -1  
$EndComp
...
U 1 1 60B8B9D0
P 1550 6500
F 0 "U8" H 1850 7150 50  0000 C CNN
...
U 1 1 60C57DBB
P 3500 6550
F 0 "U9" H 3800 7200 50  0000 C CNN
...
U 1 1 60C57DAE
P 2650 7000
F 0 "C15" H 2400 7050 50  0000 L CNN
...
F 5 "yes" H 2650 7000 50  0001 C CNN "Populate"
	1    2650 7000
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 60CC9390
P 5450 6550
F 0 "U10" H 5750 7200 50  0000 C CNN
F 1 "74HC595D" H 5750 7100 50  0000 C CNN
F 2 "Digikey:SOIC-16_W3.90mm" H 5450 6550 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/sn74hc595.pdf" H 5450 6550 50  0001 C CNN
F 4 "C5947" H 5450 6550 50  0001 C CNN "LCSC"
F 5 "https://www.ti.com/lit/ds/symlink/sn74hc595.pdf?HQS=dis-dk-null-digikeymode-dsf-pf-null-wwe&ts=1622821550284" H 5450 6550 50  0001 C CNN "DK_Datasheet_Link"
F 6 "https://www.digikey.com/en/products/detail/texas-instruments/SN74HC595DT/1571266" H 5450 6550 50  0001 C CNN "DK_Detail_Page"
F 7 "Shift Register Serial to parallel" H 5450 6550 50  0001 C CNN "Description"
F 8 "SN74HC595DR" H 5450 6550 50  0001 C CNN "MPN"
F 9 "Texas Instruments" H 5450 6550 50  0001 C CNN "Manufacturer"
F 10 "yes" H 5450 6550 50  0001 C CNN "Populate"
	1    5450 6550
	1    0    0    -1  
$EndComp
...
U 1 1 60CC939C
P 4600 7000
F 0 "C16" H 4350 7050 50  0000 L CNN
F 1 "0.1uF" H 4250 6950 50  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric" H 4638 6850 50  0001 C CNN
F 3 "~" H 4600 7000 50  0001 C CNN
F 4 "C28233" H 4600 7000 50  0001 C CNN "LCSC"
F 5 "yes" H 4600 7000 50  0001 C CNN "Populate"
	1    4600 7000
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 60CC93AB
P 5450 7300
F 0 "#PWR0111" H 5450 7050 50  0001 C CNN
F 1 "GNDD" H 5455 7144 50  0000 C CNN
...
AR Path="/60E60D68" Ref="X10"  Part="1" 
F 0 "X10" V 5850 7350 50  0000 L CNN
F 1 "HEADER_4-PIN_0.1" V 6000 7350 50  0000 L CNN
F 2 "Connector_PinSocket_2.54mm:PinSocket_1x04_P2.54mm_Vertical" H 5900 7750 50  0001 C CNN
F 3 "~" H 5900 7750 50  0001 C CNN
F 4 "DNP" H 5900 7750 50  0001 C CNN "Populate"
F 5 "YesYes" H 5900 7750 50  0001 C CNN "User Optional"
	1    5900 7750
	0    1    1    0   
$EndComp
Wire Wire Line
