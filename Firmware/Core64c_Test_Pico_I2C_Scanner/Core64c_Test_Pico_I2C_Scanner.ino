/*
Modified 2021-08-07 by Andy to work with I2C1 on Pico pins 14,15
Using the official "Arduino Mbed OS RP2040 Boards" version 2.3.1 support through Boards Manager (Not the Earle version)
...
change as follows in file "pins_arduino.h" located in Macintosh HD ▸ Users ▸ ageppert ▸ Library ▸ Arduino15 ▸ packages ▸ arduino ▸ hardware ▸ mbed_rp2040 ▸ 2.3.1 ▸ variants ▸ RASPBERRY_PI_PICO
  // Wire
  #define PIN_WIRE_SDA        (10u)  // GP10 is Pico pin 14
  #define PIN_WIRE_SCL        (11u)  // GP11 is Pico pin 15
...
// 2021-08-07 Updated to detect board type at compile time and adjust IO map accordingly.
#include "Detect_Board.h"
#include "Hardware_IO_map.h"
// Nothing needed! Teensy just uses the default pins.

#include <Wire.h>

void setup() {
  // PICO
  // Default pins are 9 and 10 (GP6 and 7) if nothing is specified, 
  // unless pins_arduino.h is modified (which they are to make this work).
